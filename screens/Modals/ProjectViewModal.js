...
class ProjectViewModal extends Component {
    constructor(props) {
        super(props);
        this.state = { _id: '', formData: { projectName: '', customer: '', projectPhase: '', description: '' } }
    }
    render() {
        const { formData } = this.state;
        return (
            <ViewModal id={this.props.modalId}  title={formData.projectName+" Project View"}>
                <div className="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" className="nav nav-tabs bar_tabs" role="tablist">
                        ...
                        <li role="presentation" className=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Project Phase</a>
                        </li>
                        <li role="presentation" className=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Estimation Factors</a>
                        </li>
                    </ul>
